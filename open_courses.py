#open_courses.py
#Imani Chilongani
"""This module contains a function that scrapes Cornell's 
student center and returns the number of open spots in a class"""
...
def check_course(netid,password,term,department,number,c_index=0):
	...
	IMPORTANT: Chrome and chrome driver are required for this function to work
	...
	Precondition: Term is a valid Cornell term of type String, with 
					name of term (starting with capital latter) 
					placed before year. E.g "Spring 2017"

	Parameter department: Requested class department
	Precondition: department is a Cornell department in valid abbreviated
					form and type String, also len(deparment)<=5
	...
	Precondition: index is an int and is a valid index of a section of the
					...
					the section appears on the search results page starting
					with 0 for the section at the top of the page) and is >=0,
					default value is 0
	"""
	...
	driver = webdriver.Chrome("/Users/imanichilongani/Documents"+
